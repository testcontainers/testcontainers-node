...
describe("parseComposeContainerName", () => {
  it.concurrent("should remove project name label", () => {
  ...
  it.concurrent("should resolve explicit container name", () => {
  ...
  it.concurrent("should throw error if unable to resolve container name", () => {
