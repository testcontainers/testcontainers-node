...
describe("Retry", () => {
  describe("IntervalRetry", () => {
    it.concurrent("should not retry when predicate succeeds", async () => {
    ...
    it.concurrent("should retry when predicate fails", async () => {
    ...
    it.concurrent("should invoke timeout handler on timeout", async () => {
